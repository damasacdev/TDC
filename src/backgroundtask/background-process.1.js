...
window.onload = function() {
    ...
    //     db = require('./mysqlFn.js');
    //     db.Config('192.168.1.95', 'damasac', 'damasac!@#$%', 'tdcbot', '3306');
    //     db.querySql('SELECT * FROM `user`').then(res => {
    //         console.log(res)
    //         ipcRenderer.send('getProcessData', res);
    //     }).catch(err => {
    //         console.log(err);
    //     });
    ...
    try {
        ...
        // let timer2 = Observable.timer(0, 2000);
        // timer2.subscribe(() => {
        ...
        //     if (ipcRendererCheck == true) {
        //         ipcRenderer.send('isOnline', isOnlineCheck);
        //     }
            ...
            if (status == '1') {
                ...
                controlTimerCommand = timerCommand.subscribe(() => {
                    ...
                    if (checkJob['command'] == 0) {
                        ...
                        try {
                            if (showConsole == true) {
                                console.log(commandQuery + " " + loopCommandQuery2 + " " + loopCommandQuery3);
                            }
                            ...
                            // if (ipcRendererCheck == true) {
                            //     ipcRenderer.send('background-send-job', "Execute Command...");
                            // }
                            ...
                            if (commandQuery == 1) {
                                ...
                                db.querySql(sqlStep1).then(dataStep1 => {
                                    // if (showConsole == true) {
                                    //     console.log(dataStep1);
                                    // }
                                    if (dataStep1 != '') {
                                        $.each(dataStep1, (keyStep1, valueStep1) => {
                                            var urlGetCommand = dataConstant[8].value + "/buffe-command/enable";
                                            service(urlGetCommand, { token: dataLogin['access_token'], id: valueStep1['id'] }, 'GET').then(dataV1 => {
                                                if (showConsole == true) {
                                                ...
                                                db.querySql(sqlUpdateCommand).then(dataUpdateCommdand => {
                                                    if (showConsole == true) {
                                                        console.log(dataUpdateCommdand);
                                                    }
                                                    commandQuery = 2;
                            ...
                            if (commandQuery == 2 && loopCommandQuery2 == 0) {
                                if (showConsole == true) {
                                ...
                                if (loopCommandQuery2 == 0) {
                                    ...
                                    db.querySql(sqlStep2).then(dataStep2 => {
                                        // console.log(dataStep2);
                                        if (dataStep2 != '') {
                                            $.each(dataStep2, (keyStep2, valueStep2) => {
                                                ...
                                                if (c_presql != '') {
                                                    db.querySql(c_presql).then(dataCpresql => {
                                                        if (showConsole == true) {
                                                            console.log(dataCpresql);
                                                        }
                                                        if (c_sql != '') {

                                                            db.querySql(c_sql).then(dataCsql => {
                                                                if (showConsole == true) {
                                                                ...
                                                                db.querySql(sqlUpdate).then(dataUpdateCommand => {
                                                                    ...
                                                                    loopCommandQuery2++;
                                                                    if (loopCommandQuery2 == dataStep2.length) {
                                                                        commandQuery = 3;
                                                                        loopCommandQuery2 = 0;
                                                                    }
                                                                    ...
                                                                    db.querySql(sqlUpdateErr).then(dataUpdateErr => {
                                                                        if (showConsole == true) {
                                                                            console.log(dataUpdateErr);
                                                                        }
                                                                        loopCommandQuery2++;
                                                                        if (loopCommandQuery2 == dataStep2.length) {
                                                                            commandQuery = 3;
                                                                ...
                                                                if (ipcRendererCheck == true) {
                                                                    ipcRenderer.send('background-send-job', 'Query SQL Error = ' + err);
                                                                }

                                                                if (saveLog == true) {
                                                                    logFn.writerLog(filename, getDateTime(new Date()) + 'Query SQL Error = ' + err + ' \r\n');
                                                                }
                                                                loopCommandQuery2++;
                                                                if (loopCommandQuery2 == dataStep2.length) {
                                                                    commandQuery = 3;
                                                    ...
                                                    if (c_sql != '') {
                                                        ...
                                                        db.querySql(c_sql).then(dataCsql => {
                                                            ...
                                                            db.querySql(sqlUpdate).then(dataUpdateCommand => {
                                                                ...
                                                                if (saveLog == true) {
                                                                    logFn.writerLog(filename, getDateTime(new Date()) + 'Command Execute error (put json result to localhost) \r\n');
                                                                }
                                                                if (dataConfigSql['dbtypes'] == '0') { //mysql
                                        ...
                                        db.querySql(sqlUpdateErr).then(dataErr => {
                                            if (showConsole == true) {
                                                console.log('Command (put json result to localhost)');
                                            }
                                            if (ipcRendererCheck == true) {
                            ...
                            if (commandQuery == 3 && loopCommandQuery3 == 0) {
                                ...
                                if (loopCommandQuery3 == 0) {
                                    ...
                                    db.querySql(sqlStep3).then(dataStep3 => {
                                        // console.log(dataStep3);
                                        if (dataStep3 != '') {
                                            $.each(dataStep3, (keyStep3, valueStep3) => {
                                                ...
                                                db.querySql(sqlSend).then(dataSend => {
                                                    ...
                                                    service(urlSyncCommand, paramSync, 'POST').then(dataCommandService => {
                                                        ...
                                                        if (dataCommandService['result'] == 'OK') {
                                                            ...
                                                            if (dataConfig[19].value == '1') {
                                                                ...
                                                                db.querySql(sqlDel).then(dataUpdate => {
                            ...
                            if (commandQuery == 4) {
                                ...
                                db.querySql(sqlStep4).then(dataStep4 => {
                                    ...
                                    if (dataStep4[0]['total'] == 0) {
                                        ...
                                        service(urlcommand, { token: dataLogin['access_token'] }, 'GET').then((commandDataServe) => {
                                            ...
                                            if (commandDataServe['status'] == null) {
                                                ...
                                                if (commandDataServe['ctype'] != 'SQL') {
                                                    ...
                                                    if (c_presql != '') {
                                                        db.querySql(c_presql).then(dataPsql => {
                                                            // console.log(dataPsql);
                                                            if (c_sql != '') {

                                                                db.querySql(c_sql).then(dataSql => {
                        ...
                        try {
                            if (checkTransfer == true) {
                                ...
                                if (syncQuery == 0) {
                                    ...
                                    db.querySql(sql).then(dataTransfer => {
                                        ...
                                        if (dataTransfer.length > 0) {
                                            ...
                                            $.each(dataTransfer, (kTransfer, vTransfer) => {
                                                ...
                                                t_presql = t_presql.replace(/_HIS_DB_/g, arg['dataConfigSql']['dbnames']);
                                                t_sql = t_sql.replace(/_HIS_DB_/g, arg['dataConfigSql']['dbnames']);
                                                // if (showConsole == true) {
                                                //     console.log(t_presql + t_sql);
                                                // }
                                                if (t_presql != '') {
                                                    db.querySql(t_presql).then(dataPsql => {
                                                        if (showConsole == true) {
                                                            console.log(dataPsql);
                                                        }
                                                    }).catch(err => {
                                ...
                                if (syncQuery == 2) {
                                    ...
                                    db.querySql(sql).then(dataBuffeTransfer => {
                                        if (showConsole == true) {
...
async function syncQ() {
    try {
        if (checkSyncQ == false) {
            ...
            // let sqlTB = '';
            // if (dataConfigSql['dbtypes'] == '0') { //mysql
            //     sqlTB = "SELECT DISTINCT f_tname FROM `" + dataConstant[0].value + "`.`buffe_fetch_queue` ";

            // } else if (dataConfigSql['dbtypes'] == '1') { //mssql
            //     sqlTB = "SELECT DISTINCT f_tname FROM [" + dataConfigSql['schemas'] + "].[buffe_fetch_queue]  ";
            ...
            for (var j = 0; j < data43File.length; j++) {
                ...
                if (dataConfigSql['dbtypes'] == '0') { //mysql
                    ...
                    countSqlT = "SELECT  COUNT(*) AS dataT FROM `" + dataConstant[0].value + "`.`buffe_transfer` WHERE SUBSTRING_INDEX(`table`,'f_',-1) = SUBSTRING_INDEX('" + data43File[j]['f43'] + "','f_',-1)";
                } else if (dataConfigSql['dbtypes'] == '1') { //mssql
                    countSqlQ = "SELECT  COUNT(*) AS dataQ FROM [" + dataConfigSql['schemas'] + "].[buffe_fetch_queue]   WHERE f_tname = '" + data43File[j]['f43'] + "'";
                    countSqlT = "SELECT  COUNT(*) AS dataT FROM [" + dataConfigSql['schemas'] + "].[buffe_transfer]   WHERE [table] = '" + data43File[j]['f43'] + "'";
                } else if (dataConfigSql['dbtypes'] == '2') { //
                ...
                let countAllData = parseInt(countQ[0]['dataQ']) + parseInt(countT[0]['dataT']);
                dataQAll += countAllData;
                dataQ.push({ sitecode: dataConfig[0]['value'], table: data43File[j]['f43'], qleft: countAllData });
            ...
            dataQ.push({ sitecode: dataConfig[0]['value'], table: 'All', qleft: dataQAll });
            if (showConsole == true) {
                console.log(dataQ);
            }
            if (ipcRendererCheck == true) {
                ipcRenderer.send('background-send-countQueue', dataQ);
